...
#define PMIX_CONFIGURE_CLI " \'--disable-man-pages\' \'--disable-debug\' \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/external/external.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/external/external.h\"' \'--prefix=/opt/ompi-4.1.2\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/home/coder/ProjectoPPD/openmpi-4.1.2 -I/home/coder/ProjectoPPD/openmpi-4.1.2 -I/home/coder/ProjectoPPD/openmpi-4.1.2/opal/include -I/home/coder/ProjectoPPD/openmpi-4.1.2/opal/include    \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "2025-11-26T14:43:49"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "ee3218856638"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "coder"
...
#define PMIX_PACKAGE_STRING "PMIx coder@ee3218856638 Distribution"
